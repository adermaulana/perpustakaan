                            ...
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="container">
                                        ...
                                        @endif
                                        <form action="{{ route('edit.anggota', $anggota->id) }}" method="POST"
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <h6>Telepon</h6>
                                                        <input type="number" name="telepon" value="{{ $anggota->telepon }}"
                                                            class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-xs-6 col-sm-6 col-md-6">
                                                ...
                                                <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <h6>Alamat</h6>
                                                        <textarea class="form-control" name="alamat" id="" cols="30" rows="10" required>{{ $anggota->alamat }}</textarea>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="col-xs-6 col-sm-6 col-md-6">
